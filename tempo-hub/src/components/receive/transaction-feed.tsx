    ...
    return (
      <Card>
        <CardContent className="p-6 text-center text-muted-foreground">
          ...
          <p className="text-sm mt-1">Transactions will appear here when you receive payments</p>
        </CardContent>
      </Card>
    )
  }
  ...
  return (
    <div className="space-y-3">
      {transactions.map((tx) => {
        ...
        return (
          <Card key={tx.id} className="hover:bg-card/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <p className="font-semibold text-lg">
                        +{parseFloat(tx.formattedAmount).toFixed(2)} {tokenInfo?.symbol || tx.tokenSymbol}
                      </p>
                    </div>
